 ...
 */
final class Version20250109141809 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE author (id SERIAL NOT NULL, last_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, pseudonym VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
